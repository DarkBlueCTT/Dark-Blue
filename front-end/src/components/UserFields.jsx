...
const UserField = (props) => {
    return (
        props.users.map((val, idx) => {
            let name = `name-${idx}`, allowed = `allowed-${idx}`, is_admin = `admin-${idx}`, admin_initial_state = `admin_initial_state-${idx}`, positive_points = `positive_points-${idx}`, negative_points = `negative_points-${idx}`
            return (
                <tr key={val.index} className="user-field">
                    ...
                    <td>
                        <CheckboxControlled name="is_admin" id={is_admin} checked={val.is_admin} onChange={props.onChange}></CheckboxControlled>

                    </td>
                    <td>
                        <CheckboxControlled name="admin_initial_state" id={admin_initial_state} checked={val.admin_initial_state} onChange={props.onChange}></CheckboxControlled>
