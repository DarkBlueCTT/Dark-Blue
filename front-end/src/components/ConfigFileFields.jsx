...
const ConfigFileField = (props) => {
    return (
        props.configfiles.map((val, idx) => {
            let filepath = `filepath-${idx}`, default_value = `default_value-${idx}`, positive_value = `positive_value-${idx}`, negative_value = `negative_value-${idx}`, positive_points = `positive_points-${idx}`, negative_points = `negative_points-${idx}`, create = `create-${idx}`, positive_message = `positive_message-${idx}`, negative_message = `negative_message-${idx}`
            return (
                <tr key={val.index}>
                    <td>
